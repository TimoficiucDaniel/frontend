        ...
        <React.Fragment>
            <Router>
                ...
                <Routes>
                    ...
                    {/*<Route path="/cubes/stats" element={<PrivateRoute><GetCubesAlphWithPriceBigger200/></PrivateRoute>}/>*/}
                    ...
                    {/*<Route path="/producers/:producerId/details" element={<PrivateRoute><ProducerDetails/></PrivateRoute>}/>*/}
                    {/*<Route path="/producers/:producerId/edit" element={<PrivateRoute><ProducerEdit/></PrivateRoute>}/>*/}
                    {/*<Route path="/producers/:producerId/delete" element={<PrivateRoute><ProducerDelete/></PrivateRoute>}/>*/}
